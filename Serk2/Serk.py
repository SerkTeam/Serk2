        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Key","Command","Help"]:
					if wait["lang"] == "JP":
            ...
            elif ("Serk1 gn " in msg.text):
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Serk1 gn ","")
						ki.updateGroup(X)
					else:
						ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("Serk2 gn " in msg.text):
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Serk2 gn ","")
						kk.updateGroup(X)
					else:
						kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("Serk3 gn " in msg.text):
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.name = msg.text.replace("Serk3 gn ","")
						kc.updateGroup(X)
					else:
            ...
            elif "Serk1 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Serk1 kick ","")
					ki.kickoutFromGroup(msg.to,[midd])
            elif "Serk2 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Serk2 kick ","")
					kk.kickoutFromGroup(msg.to,[midd])
            elif "Serk3 kick " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Serk3 kick ","")
            ...
            elif "Serk1 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Serk1 invite ","")
					ki.findAndAddContactsByMid(midd)
					ki.inviteIntoGroup(msg.to,[midd])
            elif "Serk2 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Serk2 invite ","")
					kk.findAndAddContactsByMid(midd)
					kk.inviteIntoGroup(msg.to,[midd])
            elif "Serk3 invite " in msg.text:
				if msg.from_ in admin:
					midd = msg.text.replace("Serk3 invite ","")
				...
				if msg.from_ in admin:
					...
					cl.sendMessage(msg)
            elif msg.text in ["Serk1"]:
				if msg.from_ in admin:
					msg.contentType = 13
					msg.contentMetadata = {'mid': Amid}
					ki.sendMessage(msg)
            elif msg.text in ["Serk2"]:
				if msg.from_ in admin:
					msg.contentType = 13
					msg.contentMetadata = {'mid': Bmid}
					kk.sendMessage(msg)
            elif msg.text in ["Serk3"]:
                if msg.from_ in admin:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': Bmid}
                    cl.sendMessage(msg)
            elif msg.text in ["Serk4"]:
                if msg.from_ in admin:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': Bmid}
                    kc.sendMessage(msg)
...
#-----------------------------------------------
            ...
            elif msg.text in ["Serk join","Serk masuk"]:
				if msg.from_ in admin:
...
#.acceptGroupInvitationByTicket(msg.to,Ticket)
				...
				if msg.from_ in admin:
							...
							kc.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["Serk out","Serk pulang"]:
				if msg.from_ in admin:
					if msg.toType == 2:
						ginfo = cl.getGroup(msg.to)
						try:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    cl.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*1͠ Ready")
                    ki.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*2 Ready")
                    kk.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*3 Ready")
                    kc.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*4 Ready")
#-----------------------------------------------
            elif "Serk say " in msg.text:
					bctxt = msg.text.replace("Serk say ","")
					cl.sendText(msg.to,(bctxt))
					ki.sendText(msg.to,(bctxt))
            elif "Serk2 say " in msg.text:
					bctxt = msg.text.replace("Serk2 say ","")
					cl.sendText(msg.to,(bctxt))
					ki.sendText(msg.to,(bctxt))
...
#-----------------------------------------------
        #-------------Fungsi Spam Start---------------------#
                ...
                kc.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                cl.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                kk.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                kc.sendText(msg.to,"􀔃􀆶squared up!􏿿")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
                        ...
                        kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ™RadenRamadhan™ \n\nLike Like LIke\nId: line://line.me/R/ti/p/%40dlh6592k")
                        print "Lagi Di Proses"
					except:
							pass
				else:
						print "Sudah DiLike"
